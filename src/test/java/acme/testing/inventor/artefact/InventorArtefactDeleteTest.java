...
public class InventorArtefactDeleteTest extends TestHarness{
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/artefact/delete-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(20)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/artefact/delete-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
