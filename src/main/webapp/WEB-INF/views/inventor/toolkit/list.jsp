...
<acme:list>	
	...
	<acme:list-column code="inventor.toolkit.list.label.description" path="description" width="35%"/>
	<acme:list-column code="inventor.toolkit.list.label.totalPrice" path="money" width="15%"/>		
</acme:list>
